  ...
  const filteredDemandas = useMemo(() => {
    ...
    return demandas.filter((demanda) => {
      ...
      if (filters.tipoDemanda && demanda.tipoDemanda !== filters.tipoDemanda)
        return false;
      if (filters.analista && demanda.analista !== filters.analista)
        return false;
  ...
  return (
    <div>
      ...
      <table className={styles.table}>
        <thead>
          <tr>
            <th className={styles.tableHeader}>SGED</th>
            <th className={styles.tableHeader}>Tipo de Demanda</th>
            <th className={styles.tableHeader}>Autos Administrativos</th>
            <th className={styles.tableHeader}>Orgão</th>
            <th className={styles.tableHeader}>Analista</th>
            <th className={styles.tableHeader}>Status</th>
            <th className={styles.tableHeader}>Data Inicial</th>
            <th className={styles.tableHeader}>Data Final</th>
          </tr>
        </thead>
        <tbody>
          {currentItems.map((demanda: Demanda) => (
            ...
            >
              ...
              <td className={styles.tableCell}>{demanda.dataInicial}</td>
              <td className={styles.tableCell}>{demanda.dataFinal || '-'}</td>
            </tr>
          ))}
        </tbody>
      </table>

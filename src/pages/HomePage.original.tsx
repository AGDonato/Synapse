      ...
      <section className={styles.statsSection}>
        ...
        <div className={styles.demandsAnalysisSection}>
          ...
          <div className={styles.chartsGrid}>
            ...
            <div className={styles.chartCardLarge}>
              <div className={styles.chartPadding}>
                <div>
                  <div
                    className={styles.flexAlignCenterMb025}
                  >
                    <div
                      className={styles.titleIndicatorBlue}
                    />
                    <h3
            ...
            <div className={`${styles.chartCard} ${styles.flex035}`}>
              <div
                className={styles.paddingAndFlexCol}
              >
                <div>
                  <div
                    className={styles.flexAlignCenterMb025}
                  >
                    <div
                      className={styles.titleIndicatorGreen}
                    />
                    <h3
                      className={styles.sectionTitle}
                    >
          ...
          <div className={`${styles.gridTwoCols} ${styles.marginTop1}`}>
            ...
            <div>
              <div className={`${styles.chartCardComplete} ${styles.height100} ${styles.flexColumn}`}>
                <div className={styles.chartContentContainer}>
                  <div>
                    <div className={styles.titleSectionContainer}>
                      <div
                        className={styles.titleIndicatorPurple}
                      />
                  ...
                  <div
                    className={`${styles.flexAlignCenter} ${styles.flex1}`}
                  >
                    <DemandTypesChart
                      selectedYears={filtrosEstatisticas.anos}
                    />
            ...
            <div>
              <div
                className={styles.chartCardFullHeight}
              >
                <div className={styles.chartContentPadded}>
                  <div>
                    <div className={styles.titleSectionContainer}>
                      <div
                        className={styles.titleIndicatorBlue2}
                      />
                      <h3 className={styles.sectionTitle}>
                        Status por Ano
                      </h3>
        ...
        <div className={styles.documentsAnalysisSection}>
          ...
          <div className={styles.flexJustifyEndMb1_5}>
          ...
          <div className={styles.chartsGrid}>
            {/* Tipos de Documentos */}
            <div className={`${styles.chartCard} ${styles.flex065}`}>
              <div
                className={styles.paddingAndFlexColHeight}
              >
                <div className={styles.marginBottom15}>
                  <div
                    className={styles.flexAlignCenterMb025}
                ...
                <div className={styles.gridThreeColsFlex1}>
                  {/* Linha 1 */}
                  <div className={`${styles.statsCardBase} ${styles.statsCardGray}`}>
...
className={styles.labelSmall}
            ...
            <div className={`${styles.chartCard} ${styles.flex035}`}>
              ...
              >
                <div className={styles.marginBottom15}>
                  ...
                  >
                    <div
                      className={styles.titleIndicatorOrange}
                    />
                    <h3
                      className={styles.sectionTitle}
                    >
                ...
                <div className={styles.flexColumnGap1_5}>
                  <div
                    className={styles.statsCardTall}
                  >
                    <div className={styles.valueDisplay}>
                      {(() => {
          ...
          <div className={styles.chartsGridWithMarginTop}>
            {/* Decisões Judiciais */}
            <div
              className={styles.chartCardHalf}
            >
              <div
                className={styles.paddingAndFlexColHeight}
              >
                <div className={styles.marginBottom15}>
                  ...
                  >
                    <div
                      className={styles.titleIndicatorIndigo}
                    />
                    <h3
                      className={styles.sectionTitle}
                    >
                ...
                <div
                  className={styles.gridTwoColsEqualMb15}
                >
                  <div
                    className={styles.statsCardTall}
                  >
            ...
            >
              ...
              >
                <div className={styles.marginBottom15}>
                  ...
                  >
                    <div
                      className={styles.titleIndicatorRed}
                    />
                    <h3
                      className={styles.sectionTitle}
                    >
                ...
                <div
                  className={styles.flexColumnGapFlex1}
                >
                  {/* Estatísticas em grid */}
                  <div
                    className={styles.gridTwoColsEqual}
                  >
                    {/* Volume Total */}
                    <div
                      className={styles.mediaStatsCard}
                    >
                      <div
                        className={styles.valueTextLarge}
                      >
                        {(() => {
                          const selectedYears = getSelectedYears();
                          const filteredDocs = documentos.filter(doc => {
                      ...
                      <div
                        className={styles.labelTextSmall}
                      >
                        Volume Total
                      </div>
                    </div>
                  ...
                  {/* Gráfico */}
                  <div
                    className={styles.chartGraphFlexContainer}
                  >
                    <div className={styles.width100Height100}>

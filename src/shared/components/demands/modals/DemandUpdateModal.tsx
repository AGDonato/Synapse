...
import { getModalType, hasChanges, initializeTempStates, prepareUpdateData } from './utils';
...
export default function DemandUpdateModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title={`Atualizar SGED ${demanda.sged}`}>

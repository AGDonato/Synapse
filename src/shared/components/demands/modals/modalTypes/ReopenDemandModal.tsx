      ...
      <div className={styles.formSection}>
        ...
        <div className={styles.formGroup}>
          ...
          >
            ...
            <br />
            Data de Reabertura: {tempStates.dataReaberturaFormatted || 'Não informada'}
          </div>
        </div>
      </div>
    );
    ...
    <div className={styles.formSection}>
      ...
      {tempStates.isReaberto && (
        <div className={styles.warningText}>
          <strong>Atenção:</strong> A reabertura da demanda mudará o status para "Em Andamento" até
          que uma nova data final seja definida.
        </div>
      )}
    </div>
  );

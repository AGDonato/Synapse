...
import styles from './SolicitantesOrgansChart.module.css';
        ...
        createPortal(
          ...
          >
            ...
            >
              ...
              >
                <strong className={styles.modalText}>{modalData.organs.length} órgãos</strong> com
                total de{' '}
                <strong className={styles.modalText}>

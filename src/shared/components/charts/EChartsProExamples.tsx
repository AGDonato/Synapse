...
export default function EChartsProExamples() {
  ...
  const getVirtualData = () => {
    ...
    for (let time = date; time <= end; time += dayTime) {
      data.push([new Date(time).toISOString().split('T')[0], Math.floor(Math.random() * 100)]);
    }
    return data;
  };
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        >
          ...
          >
            ...
            >
              <li>
                <strong>Sankey:</strong> Fluxos e relacionamentos
              </li>
              <li>
                <strong>Sunburst:</strong> Hierarquias circulares
              </li>
              <li>
                <strong>ThemeRiver:</strong> Evolução temporal
              </li>
              <li>
                <strong>Calendar:</strong> Heatmap de calendário
              </li>
              <li>
                <strong>Gauge:</strong> Indicadores KPI
              </li>
              <li>
                <strong>Graph:</strong> Redes e grafos
              </li>
              <li>
                <strong>Parallel:</strong> Coordenadas paralelas
              </li>
              <li>
                <strong>Pictorial:</strong> Gráficos pictóricos
              </li>
              <li>
                <strong>GL/3D:</strong> Visualizações 3D
              </li>
            </ul>
          </div>
        </div>

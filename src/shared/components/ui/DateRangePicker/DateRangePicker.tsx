    ...
    <div className={`${styles.dateRangeContainer} ${className || ''}`}>
      ...
      <div className={styles.inputContainer}>
        ...
        >
          ...
          <span className={styles.dateText}>{hasSelection ? formatDateRange() : placeholder}</span>
          {hasSelection && (
            <button
              type='button'
          ...
          <div className={styles.pickerContainer}>
            <div className={styles.pickerWrapper}>
              ...
              <div className={styles.pickerActions}>
                ...
                <button type='button' className={styles.clearAllButton} onClick={handleClearDates}>
                  Limpar
                </button>
              </div>
            </div>

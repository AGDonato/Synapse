...
export const dynamicImports = {
  ...
  routes: {
    home: () => import('../../pages/dashboard/index'),
    demandas: () => import('../../pages/demandas/DemandasPage'),
    documentos: () => import('../../pages/documentos/DocumentosPage'),
    cadastros: () => import('../../pages/cadastros/CadastrosPage'),
    relatorios: () => import('../../pages/relatorios/RelatoriosPage'),
    analytics: () => import('../../pages/relatorios/AnalyticsPage'),
  },

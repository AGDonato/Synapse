...
export const BackupPanel: React.FC<BackupPanelProps> = ({ onClose }) => {
  ...
  const getBackupTypeIcon = (type: BackupType) => {
    switch (type) {
      case 'manual': return <User size={16} />;
      case 'automatic': return <RotateCcw size={16} />;
  ...
  const getScopeIcon = (scope: BackupScope) => {
    switch (scope) {
      case 'all': return <Database size={16} />;
      case 'user-data': return <User size={16} />;
      case 'application-state': return <Cpu size={16} />;
            ...
            <div className={styles.statInfo}>
              <span className={styles.statValue}>
                {metrics.lastBackupTime 
                  ? formatDateTime(metrics.lastBackupTime)
                  : 'Nenhum'
                }
              </span>
          ...
          <div className={styles.section}>
            <div className={styles.sectionHeader}>
              ...
              <button
                ...
                onClick={handleQuickActions.refreshList}
              >
                <RotateCcw size={16} />
                Atualizar
              </button>
                        ...
                        <div className={styles.backupType}>
                          ...
                          <span className={styles.backupTypeText}>
                            {backup.type === 'manual' ? 'Manual' :
                             backup.type === 'automatic' ? 'Automático' :
          ...
          <div className={styles.section}>
            <div className={styles.sectionHeader}>
              ...
              <div className={styles.schedulerStats}>
                <span>{schedulerStats.enabledSchedules}/{schedulerStats.totalSchedules} ativos</span>
              </div>
            </div>

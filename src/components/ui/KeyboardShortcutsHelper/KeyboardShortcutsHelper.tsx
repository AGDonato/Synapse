...
export const KeyboardShortcutsHelper: React.FC<KeyboardShortcutsHelperProps> = ({
  ...
  const groupedShortcuts = shortcuts.reduce((groups, shortcut) => {
    ...
    const category = shortcut.description.includes('busca') ? 'Navegação' : 
                    shortcut.description.includes('sidebar') || shortcut.description.includes('início') ? 'Interface' :
                    shortcut.description.includes('configurações') || shortcut.description.includes('ajuda') ? 'Sistema' : 
                    'Geral';
          ...
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.footer}>
              <div className={styles.footerNote}>
                💡 Dica: Pressione <kbd className={styles.inlineKey}>Shift</kbd> + <kbd className={styles.inlineKey}>?</kbd> a qualquer momento para ver esta lista
              </div>
            </div>
          </div>
        </div>

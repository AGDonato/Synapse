...
export const useAutenticacaoAvancada = (): TipoContextoAutenticacaoAvancada => {
  ...
  if (!contexto) {
    throw new Error(
      'useAutenticacaoAvancada deve ser usado dentro de ProvedorAutenticacaoAvancada'
    );
  }
  return contexto;
};

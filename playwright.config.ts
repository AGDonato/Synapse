...
export default defineConfig({
  ...
  // globalSetup: require.resolve('./src/test/e2e/setup/global-setup.ts'), // File doesn't exist
  // globalTeardown: require.resolve('./src/test/e2e/setup/global-teardown.ts'), // File doesn't exist
